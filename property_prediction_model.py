...
Usage:
  python property_prediction_model.py train   # trains both models
  python property_prediction_model.py serve   # starts FastAPI server
  python property_prediction_model.py predict # single prediction CLI
"""
...
if __name__ == "__main__":
    ...
    if cmd == "train":
        ...
        print("Usage: python property_prediction_model.py [train|serve|demo]")
